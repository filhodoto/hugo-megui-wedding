...
export default function OurHistory() {
  return (
    <div
      id="our_history"
      className="grid xl:grid-cols-2 xl:grid-flow-col gap-x-8 py-20 md:py-26 relative m-auto min-h-lvh"
    >
      <article className="text-pretty text-lg px-6 md:px-8 xl:pl-20">
