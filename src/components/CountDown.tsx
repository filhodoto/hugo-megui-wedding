    ...
    <div className="flex pt-14 md:pt-20 justify-center gap-3 sm:gap-8">
      {Object.keys(rest).map((measure) => {
        ...
        return (
          ...
          >
            <div className="h-20 w-20 sm:w-32 sm:h-32 lg:w-40 lg:h-40 flex justify-between items-center bg-action-200 border border-action-300 rounded-lg">
              <div className="relative h-2.5 w-2.5 sm:h-3 sm:w-3 !-left-[6px] rounded-full bg-white"></div>
              <span className="font-heading lg:text-7xl sm:text-6xl text-3xl font-semibold text-white">
                {count}
              </span>
